...
# CSS para el fondo oscuro con patrón triangular
st.markdown("""
    <style>
    body {
...
# 📌 Mostrar recuadros con bordes y efecto hover
for col, categoria, descripcion in zip([col1, col2, col3, col4], categorias, descripciones):
    with col:
        st.markdown(
            f"""
            <div style="padding: 15px; border: 2px solid #4CAF50; border-radius: 10px; text-align: center; background-color: #2E2E2E; transition: 0.3s;">
                <h3 style="color: #FFD700;">{categoria}</h3>
