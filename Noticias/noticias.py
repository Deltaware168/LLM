...
# 📌 Mostrar recuadros con bordes y estilos personalizados
for col, categoria, descripcion in zip([col1, col2, col3, col4], categorias, descripciones):
    with col:
        st.markdown(
            f"""
            <div style="padding: 15px; border: 2px solid #4CAF50; border-radius: 10px; text-align: center; background-color: #f9f9f9;">
